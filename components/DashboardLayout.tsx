            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              {showBackButton && (
                <>
                  <Link
                    href={backLink}
                    className="flex items-center gap-1 sm:gap-2 text-gray-600 hover:text-gray-900 transition-colors shrink-0"
                  >
              ...
              <h1 className="text-sm font-medium hidden md:flex text-gray-600 truncate">
                {pageTitle}
              </h1>
            </div>
